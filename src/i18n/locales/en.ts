export const en = {
  ...
  list: {
    ...
    emptyHint: 'Swipe left to delete · Long-press for quick actions · Drag ≡ to reorder',
  ...
  settings: {
    title: 'Settings',
    subtitle: 'Customize language, appearance, and reminders.',
    ...
    theme: {
      title: 'Appearance',
      description: 'Pick how the app looks on your device.',
      system: 'System',
      light: 'Light',
      dark: 'Dark',
      systemHint: 'Match device settings',
      lightHint: 'Always use light theme',
      darkHint: 'Always use dark theme',
  ...
  toast: {
    ...
    imported: '{{count}} sample tasks imported',
    importFailed: 'Could not import sample tasks',
  },
  quickActions: {
